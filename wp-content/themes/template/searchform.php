...
<input type="search" class="form-control border-success col-xl-12 mb-1" id="<?php echo $unique_id; ?>" placeholder="Искать..." value="<?php echo get_search_query(); ?>" name="s">
<button type="submit" class="btn btn-danger border-success">Искать</button>  
</form>
